...
class Solver(object):
    ...
    def build_model(self):
        ...
        self.G = Generator(self.input_nc, self.n_ds, self.g_conv_dim, self.c_dim, self.g_repeat_num)
        self.D = Discriminator(self.input_nc, self.image_size, self.d_conv_dim, self.c_dim, self.d_repeat_num) 
